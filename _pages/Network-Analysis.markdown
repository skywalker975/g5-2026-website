...
In humanitarian contexts, food insecurity never happens in isolation. A sudden price spike in one urban market can cascade through trade corridors, triggering inflationary waves in rural provinces hundreds of kilometres away — and pushing millions deeper into acute food crisis (IPC Phase 3+). Project HERO's <strong>TSgraph module</strong> was built to map exactly these invisible pathways.
</p>
...
<div class="row g-4 my-4">
  ...
  <div class="col-md-4">
    <div class="glass-card card-border-top-success h-100 p-4">
      ...
      <p class="text-secondary mb-0" style="line-height: 1.6;">Determines <em>who drives whom</em>: the direction of inflationary contagion along the trade corridor.</p>
    </div>
  </div>
</div>
...
<div class="row g-4 my-4">
  <div class="col-md-6">
    <div class="glass-card p-4 h-100">
      ...
      <p class="text-secondary small mb-0"><strong>Key topological hubs:</strong> Logar, Paktya, and Gardez emerge as the top degree nodes — the critical transit corridors through which inflationary shocks propagate between eastern and central Afghanistan.</p>
    </div>
  </div>
  <div class="col-md-6">
    <div class="glass-card p-4 h-100">
...
| **SP** (Avg Shortest Path) | 2.76 | 2.98 | 3.05 | 2.59 |
  ...
  <p class="text-secondary small mt-3 mb-0">The real network's clustering coefficient (0.538) is <strong>7× higher than Erdős–Rényi</strong> and 4× higher than Barabási–Albert — strong evidence that Afghan markets form tightly knit local clusters rather than a random mesh. The relatively short average path (2.76) combined with high clustering is the hallmark of a <strong>small-world network</strong>.</p>
    </div>
  </div>
</div>
...
<div class="glass-card p-4 my-4">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-3 text-center">
      ...
      <p class="text-secondary small mb-0"><strong>Components</strong><br>The network fragments into 10 disconnected components — evidence of geographic and conflict-related market isolation.</p>
    </div>
    <div class="col-md-3 text-center">
      <p class="text-light mb-1" style="font-size: 1.5rem; font-weight: 700;">71.4%</p>
      <p class="text-secondary small mb-0"><strong>Giant Component</strong><br>25 of 35 markets belong to the largest connected subgraph — the backbone of Afghanistan's price transmission system.</p>
    </div>
    <div class="col-md-3 text-center">
...
Empirical networks consistently deviate from ER randomness and align more closely with BA scale-free topology — evidence that real humanitarian market systems are structured, not stochastic.
...
- **Distance Decay Analysis** — Exponential fitting ($W \sim e^{-\lambda d}$) to quantify spatial friction
- **Degree Distribution** — Power-law fitting ($P(k) \sim k^{-\alpha}$) to reveal market hierarchy
- **Assortativity Analysis** — Scatter plot ($k$ vs $K_{nn}$) to measure commercial homophily
